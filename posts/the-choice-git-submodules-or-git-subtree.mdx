...
<h1>Git Subtree</h1>
<p>
   As most of the blog article titles are "Git Subtree: The Git Submodules alternative" I decided to take a closer look at the second technology on my list. Knowing the basics of Git Submodules you can easily make a comparison between the effort for the major operations. I really liked <a href="https://training.github.com/downloads/submodule-vs-subtree-cheat-sheet/">this cheatsheet</a> which demonstrates the most trivial git commands for both. 
</p>
<p>
